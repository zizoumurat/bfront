...
@Component({
  selector: 'app-summary-bidding',
  templateUrl: './summary-bidding.component.html'
})
export class SummaryBiddingComponent {
  ...
  async getRequest() {
    ...
    this.getOfferList();
    this.form.get('commercialEvaluation').setValue(this.request.commercialEvaluation);
    this.form.get('technicalEvaluation').setValue(this.request.technicalEvaluation);
  }
  ...
  createForm() {
    ...
    this.form = this.fb.group({
      id: control(this.requestId),
      commercialEvaluation: control(null, [Validators.required]),
      technicalEvaluation: control(null, [Validators.required]),
    });
  }
