...
@Component({
    selector: "app-contracts-archive",
    templateUrl: "./contracts-archive.component.html",
})

export class ContractsArchiveComponent implements OnInit {
    ...
    async initialOptions() {
        ...
        this.tabItems = [
            { label: this.translateService.instant('activeContracts') },
            { label: this.translateService.instant('endedContracts') },
            { label: this.translateService.instant('canceledContracts') },
        ];
    }
