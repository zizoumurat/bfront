        ...
        this.model = [
            ...
            },
            {
                ...
                items: [
                    ...
                    {
                        label: "permission.receivables",
                        routerLink: "/customers/receivables",
                        visible: this.authHelper.isAuthorized(["suppliers.receivables"]),
                    },
                ],
            },
        ];
